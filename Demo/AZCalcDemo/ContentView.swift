...
extension AZDecimalConfig.RoundType {
    static let demoAllCases: [AZDecimalConfig.RoundType] = [
        .rup, .rPlus, .r54, .r55, .r65, .rMinus, .truncateToDigits, .keepFull
    ]
    ...
    var demoLabel: LocalizedStringKey {
        ...
        case .truncateToDigits: "rounding.mode.truncateToDigits.option"
        case .keepFull:         "rounding.mode.keepFull.option"
        }
    }
}
